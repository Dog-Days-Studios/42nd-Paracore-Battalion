...
class 42nd_Heavy_Hidden_Vest: IDA_vest_base
{
    author = "Hound";
    displayName = "[42nd] Heavy Weapon Armor Plating";
    model = "";
    scope = 2;
    scopeCurator = 2;
    scopeArsenal = 2;
...
class 42nd_Hidden_EOD_Vest: IDA_vest_base
{
    author = "Hound";
    displayName = "[42nd] EOD Armor Plating";
    model = "";
    scope = 2;
    scopeCurator = 2;
    scopeArsenal = 2;
