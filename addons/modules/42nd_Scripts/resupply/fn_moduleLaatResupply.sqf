...
private _cargoClass = [
    ...
    [
        "CargoClass",
        "Para42_Module_LaatResupply_CargoClass",
        "para42_module_laatresupply_cargoclass"
    ],
...
private _approachHeading = parseNumber format [
    ...
    [
        ...
        [
            "ApproachHeading",
            "Para42_Module_LaatResupply_ApproachHeading",
            "para42_module_laatresupply_approachheading"
        ],
        -1
    ] call _getModuleValue
...
[_logic, _notifyUnit, _cargoClass, _approachHeading] call Para42_fnc_spawnLaatResupplyServer;
