...
if (!isServer) exitWith {
    [_logic, _notifyUnit, _cargoClass, _approachHeading] remoteExecCall ["Para42_fnc_spawnLaatResupplyServer", 2];
    objNull
};

if (isNull _logic || {_cargoClass isEqualTo ""}) exitWith {objNull};
if (_logic getVariable ["42nd_laatResupplyQueued", false]) exitWith {objNull};

_logic setVariable ["42nd_laatResupplyQueued", true, true];
...
[_notifyUnit, _cargoClass, _cargoLabel, _dropPosATL, _resolvedHeading, false] call Para42_fnc_requestLaatAiResupply;
